...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      return cardEffectMine(currentPlayer, state, choice1, choice2, handPos);
			
    case remodel:
      return cardEffectRemodel(currentPlayer, state, choice1, choice2, handPos);
		
    case smithy:
      return cardEffectSmithy(currentPlayer, state, handPos);
		
    case village:
      return cardEffectVillage(currentPlayer, state, handPos);
...
int cardEffectMine(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos)
{
      int j;
